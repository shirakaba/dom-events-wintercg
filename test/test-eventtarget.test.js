...
// Skipping because the test is hard to port to our simpler test runner.
// Arguably out-of-scope anyway, as it relates to Node.js runtime behaviour.
test.skip('et-21', () => {
...
test('et-23', () => {
  ...
  ['foo', 1, false].forEach((i) =>
    throws(() => target.addEventListener('foo', i), err(i)),
  );
});
...
// FIME: Need to investigate what exactly is going wrong here.
test.skip('et-29', () => {
...
test('et-38', () => {
  ...
  ['foo', {}, [], 1, null, undefined, false, Symbol(), /a/].forEach((i) => {
